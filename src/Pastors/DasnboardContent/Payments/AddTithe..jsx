  ...
  return (
    <div>
      ...
      <main className='w-full h-full  mx-10 md:mx-44 space-y-5 mt-20 '>
          <h1  className='font-semibold font-serif sm:mx-10  text-lg md:text-md text-red-500 -mx-5'>RECENT  <span  className="text-black"> TITHES RECORDS</span></h1>
        <section >
        <Table
        size={70} 
...
export default transition(PastorsTithes);
